...
@FXML
    ...
    private void getSelected(MouseEvent event) {
       ...
       Image imageee = new Image(String.valueOf(ImageHebergement.getCellData(index)));
    Img.setFitHeight(50); //726
    Img.setFitWidth(60); //500
   Img.setImage(imageee);
...
public boolean controleTextFieldNumerique1(TextField textField) {
     int a = Integer.parseInt(textField.getText());
        if ((!textField.getText().matches(".*[0-1].*"))||(!(a>=0))) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText("0=dispo;1=indisponible");
            alert.showAndWait();
    ...
    private void Ajouter_Hebergement(ActionEvent event) throws SQLException {
       ...
       if (controleTextFieldNonNumerique(DescriptionField) || controleTextFieldNonNumerique(AdresseField) || controleTextFieldNonNumerique(TypeField) || controleTextFieldNumerique(PriceField)|| controleTextFieldNumerique1(DisponibiliteField)); else 
        {
        ...
        //sh.ajout(k4);
            Hebergement t = new Hebergement(DescriptionField.getText(), TypeField.getText(), id, AdresseField.getText(), ImageeField.getText(), id2);
            ts.ajout(t);
...
@FXML
    private void Makepdf(ActionEvent event) throws SQLException {
        try {
            ...
            Paragraph p = new Paragraph(" all Hebergements ", font);
            ...
            String req="SELECT * FROM hebergement order by description ASC";
