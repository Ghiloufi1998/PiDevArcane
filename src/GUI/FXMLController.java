...
import services.RÈservationCRUD;
...
public class FXMLController implements Initializable {
    ...
    RÈservationCRUD r = new RÈservationCRUD();
    RÈservation rs = new RÈservation();
...
//        }
   // Vol Interface
       ...
       RÈservation p = new RÈservation(sqlDate, sqlDat, ty,nb1,nb2,x);
       r.insertDes(p);
       fs.FactureInsert(p.getID_rev());
       if (!ty.equals("Voyage Organis√©")){
...
if(  (("".equals(des.getValue()) || "".equals(Type.getValue())) || "".equals( nbr_adu.getValue()))||"".equals( nbr_enf.getValue()) ){
       ...
       alert.setContentText("verifier les donn√©es");
       alert.showAndWait();
   }
