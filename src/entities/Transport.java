...
public class Transport {
    ...
    public Transport(String Type, String Description, int Disponibilité, int Prix, String Image, Hebergement Hebergement ) {
     ...
     public Transport(String Type, String Description, int Disponibilité, int Prix, String Image, int Hebergement_id ) {
        this.Type = Type;
        this.Description = Description;
        this.Disponibilité = Disponibilité;
        this.Prix = Prix;
    ...
    public Transport(String Type, String description, int disponibilité, int prix) {
        this.Type = Type;
        this.Description = Description;
        this.Disponibilité = Disponibilité;
        this.Prix = Prix;
    }
    public Transport(int Transport_id,String Type, String description, int disponibilité, int prix) {
        this.Type = Type;
        this.Description = Description;
        this.Disponibilité = Disponibilité;
        this.Prix = Prix;
...
public int getHebergement_id() {
    ...
    public String toString() {
        return "Transport{" + "Transport_id=" + Transport_id + ", Type=" + Type + ", Description=" + Description + ", Disponibilit\u00e9=" + Disponibilité + ", Prix=" + Prix + ", Image=" + Image + ", Hebergement_id=" + Hebergement_id + ", Hebergement=" + Hebergement + '}';
    }
