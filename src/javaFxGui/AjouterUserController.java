 ...
 gnd.setCellValueFactory(new PropertyValueFactory<>("gender"));
    ...
    private void addPerson(ActionEvent event) {
        try {
            ...
            String r=(String) rol.getValue();
            
             Offre f1=new Offre(1,"", "", 0, 0);
          User u1 = new User(nom, prénom, g, datenaissance, addresse, e_mail, motpasse, image, r, 0, f1.getId_offre(), f1);
   ...
   private void modifi(ActionEvent event) {
       ...
       Offre o =tab.getSelectionModel().getSelectedItem().getOffre();
